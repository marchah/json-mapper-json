...
function unitTestForJsonMapper(fct) {
  ...
  it('array with formatting 1/4', (done) => {
    fct([{
      field: 'value1',
    }, {
      field: 'value2',
  ...
  it('array with formatting 2/4', (done) => {
    fct({
      array: [
        {field: 'value1'},
        {field: 'value2'},
        ...
        'new_array': {
          path: 'array',
          formatting: (value) => {return {field: value.field + '_formatted'};},
        },
    }).then((result) => {
      expect(result).to.eql({
        'new_array': [
          {field: 'value1_formatted'},
          {field: 'value2_formatted'},
          {field: 'value3_formatted'},
        ],
      });
      done();
    }).catch(done);
  });
  it('array with formatting 3/4', (done) => {
    fct({
      array: [
        {field: 'value1'},
        {field: 'value2'},
      ...
      expect(result).to.eql({
        'new_array': ['value1_formatted', 'value2_formatted', 'value3_formatted'],
      });
      done();
    }).catch(done);
  });
  it('array with formatting 4/4', (done) => {
    fct({
      array: [
        {field: 'value1'},
        {field: 'value2'},
        ...
        'new_array': {
          path: 'array.field',
          formatting: (value) => {return {'new_field': value + '_formatted'};},
        },
    }).then((result) => {
      expect(result).to.eql({
        'new_array': [
  ...
  it('nested array with formatting 1/2', (done) => {
    fct({
      field: {
      ...
      'new_field': {
        ...
        nested: {
          'nested_array': {
            path: 'array',
            formatting: (value) => {return {'new_nested_field': value.field + '_formatted'};},
          },
        },
      },
    }).then((result) => {
      expect(result).to.eql({
        'new_field': {
          'nested_array': [
            {new_nested_field: 'value1_formatted'},
            {new_nested_field: 'value2_formatted'},
            {new_nested_field: 'value3_formatted'},
          ],
        },
      });
      done();
  ...
  it('nested array with formatting 2/2', (done) => {
    fct({
      field: {
        nested_field: 'nested_value',
        array: [
      ...
      expect(result).to.eql({
        'new_field': {
          'nested_array': ['value1_formatted', 'value2_formatted', 'value3_formatted'],
        },
      });
      done();
    }).catch(done);
  });
  it('array with key word `$root` and formatting', (done) => {
    fct({
      array: [
        {nested_field: 'value1'},
        {nested_field: 'value2'},
      ...
      'new_field': {
        ...
        nested: {
          'nested_array': {
            path: '$root.array',
            formatting: (value) => {return {'new_nested_field': value.nested_field + '_formatted'};},
          },
        },
      },
    }).then((result) => {
